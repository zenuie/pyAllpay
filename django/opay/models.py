...
class OpaySetting(models.Model):
    """ Basic Setting """
    is_SANDBOX = models.BooleanField(default=True, verbose_name='是否正式環境')
    MerchantID = models.CharField(max_length=10, verbose_name='*會員代碼')
    HASH_KEY = models.CharField(max_length=50, default='5294y06JbISpM5x9')
    HASH_IV = models.CharField(max_length=50, default='v77hoKGq4kWxNNIS')
    AIO_SANDBOX_SERVICE_URL = models.CharField(max_length=200,
                                               default='https://payment-stage.opay.tw/Cashier/AioCheckOut/V5')
    AIO_SERVICE_URL = models.CharField(max_length=200, default='https://payment.opay.tw/Cashier/AioCheckOut/V5')
    """choose List"""
...
class OpayOrder(models.Model):
    ...
    StatusList = (('待付款', '待付款'), ('已付款', '已付款'), ('付款失敗', '付款失敗'),)
    Sponsor = models.CharField(max_length=30, blank=True, verbose_name='付款人')
    Message = models.CharField(max_length=200, blank=True, verbose_name='付款人留言')
    Status = models.CharField(max_length=10, blank=True, choices=StatusList, default='待付款', verbose_name='交易狀態')
    MerchantTradeNo = models.CharField(max_length=64, unique=True, verbose_name='*交易編號')
    MerchantTradeDate = models.CharField(max_length=20,
